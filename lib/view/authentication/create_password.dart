                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Gap.h(20),
                                CustomTextField(
                                  obsecuretext: value.y % 2 == 0 ? false : true,
                                  width: size.width * .90,
                                  ...
                                  suffixIcon: value.y % 2 != 0
                                      ? IconButton(
                                          onPressed: () {
                                            // setState(() {});
                                            // value.y = VariableProvider
                                            //     .IncrementVariable(y);

                                            double values =
                                                value.setIncrement(value.y);
                                            value.setincrementy(values);
                                          },
                                          icon: const Icon(
                                            Icons.visibility_off,
                                            size: 20,
